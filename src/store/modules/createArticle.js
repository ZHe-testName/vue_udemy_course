...
export const mutationTypes = {
    createArticleStart: '[createArticle] Creaate article start',
    createArticleSuccess: '[createArticle] Creaate article success',
    createArticleFailure: '[createArticle] Creaate article failure',
};
